    ...
    return (
        <section class="bg-white dark:bg-gray-900 h-screen">
            <div class="container px-6 py-24 mx-auto lg:py-32">
                <div class="lg:flex">
                    <div class="lg:w-1/2">
                        <img class="w-14  sm:h-8" src={logo} alt="" />
                    ...
                    <div class="mt-8 lg:w-1/2 lg:mt-0">
                        <form class="w-full lg:max-w-xl">
                            <div class="relative flex items-center">
                                ...
                                <input type="text" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Enter your name" />
                            </div>
                            ...
                            <div class="mt-8 md:flex md:items-center">
                                ...
                                <Link href="#" class="inline-block mt-4 text-center text-blue-500 md:mt-0 md:mx-6 hover:underline dark:text-blue-400">
                                    Forgot your password?
                                </Link>
                            </div>
                            <p class="mt-4 text-center text-gray-600 dark:text-gray-400">Already have an account? <Link to={'/login'} className='text-blue-600 hover:underline '>Log in</Link></p>
                            <p class="mt-4 text-center text-gray-600 dark:text-gray-400">or sign in with</p>

                            <Link href="#" class=" w-2/3 mx-auto flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
