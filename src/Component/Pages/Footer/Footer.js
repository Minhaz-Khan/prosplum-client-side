...
const Footer = () => {
    return (
        <footer class="bg-gray-50 dark:bg-gray-900 mt-10">
                ...
                <div class="lg:flex">
                    <div class="w-full -mx-6 lg:w-2/5">
                        <div class="px-6 ">
                            <a href="#" className='flex items-center space-x-2'>
                                ...
                                <h5 className='uppercase font-bold text-blue-600'>Prosplum</h5>
                            </a>
                    ...
                    <div class="mt-6 lg:mt-0 lg:flex-1">
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            ...
                            <div>
                                <h3 class="text-gray-700 uppercase dark:text-white">Service</h3>
                                <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Plumbing</a>
                                <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Real Estate</a>
                                <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Drainage</a>
                            </div>
